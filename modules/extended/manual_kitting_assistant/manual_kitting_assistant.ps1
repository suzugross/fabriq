...
function New-StepButton {
    ...
    $btn.Font      = New-UiFont "Segoe UI" 10 Bold
...
$lblProgress.Font     = New-UiFont "Segoe UI" 8
...
$lblTitle.Font      = New-UiFont "Segoe UI" 11 Bold
...
$txtPrompt.Font         = New-UiFont "Segoe UI" 10
...
$btnCtrlCSend.Font      = New-UiFont "Segoe UI" 10 Bold

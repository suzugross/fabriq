...
try {
    ...
    Out-Log "[ERROR] Failed to get firewall info: $_" -ForegroundColor Red
}
...
try {
    ...
    Out-Log "[ERROR] Failed to get optional features: $_" -ForegroundColor Red
}
...
if ($isServer) {
    try {
        ...
        Out-Log "[ERROR] Failed to get server features: $_" -ForegroundColor Red
    }
}
else {

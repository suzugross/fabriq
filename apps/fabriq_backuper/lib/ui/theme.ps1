...
# ========================================
# Mirrors apps/fabriq_operator/lib/theme.ps1 visual language
# (CentreCOM-inspired light theme with a worn 2000s feel) so
# FabriqBackUper looks consistent with the main fabriq dashboard.
# Kept as a self-contained copy per satellite-app isolation
# principle: no cross-app dependencies on internal libs.
# ========================================
